...
const textos = [
  "Únete a nuestra comunidad y marca la diferencia",
  "Sé parte del cambio real hoy",
  "Haz que tu voz se escuche",
    "Crea un cambio en el mundo",
  "Únete al movimiento más grande de ayuda humanitaria"
];
    ...
    >
      ...
      >
        ...
        <MotionButton
          ...
          whileHover={{ scale: 1.05, boxShadow: "0 0 12px rgba(255,0,0,0.5)" }}
